...
@SymTab = external global [798 x i64]
...
declare void @err(i64, i64, i8*, i8*)
declare void @stkErr(i64)
declare void @argErr(i64, i64)
declare void @cntErr(i64, i64)
declare void @numErr(i64, i64)
declare void @symErr(i64, i64)
declare void @extErr(i64, i64)
declare void @atomErr(i64, i64)
declare void @pairErr(i64, i64)
declare void @lstErr(i64, i64)
declare void @varErr(i64, i64)
declare void @protErr(i64, i64)
declare i64 @xCnt(i64, i64)
declare i64 @evCnt(i64, i64)
declare i64 @evLst(i64)
...
; # (nil? (evSym X))
  %5 = icmp eq i64 %4, ptrtoint (i8* getelementptr (i8, i8* bitcast ([798 x i64]* @SymTab to i8*), i32 8) to i64)
...
$8:
  ...
  %20 = phi i32 [%17, %$6] ; # C
; # (ret $Nil)
  ret i64 ptrtoint (i8* getelementptr (i8, i8* bitcast ([798 x i64]* @SymTab to i8*), i32 8) to i64)
$9:
  %21 = phi i64 [%15, %$6] ; # X
  %22 = phi i32 [%17, %$6] ; # C
  br label %$5
