...
@SymTab = external global [888 x i64]
...
; # (nil? Y)
  %15 = icmp eq i64 %14, ptrtoint (i8* getelementptr (i8, i8* bitcast ([888 x i64]* @SymTab to i8*), i32 8) to i64)
...
; # (call $Put (hex "F7"))
  ...
  call void %54(i8 247)
; # (call $Put (hex "BF"))
  %55 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %55(i8 191)
; # (call $Put (hex "BF"))
  %56 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %56(i8 191)
; # (call $Put (hex "BF"))
  %57 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %57(i8 191)
  br label %$23
$22:
  %58 = phi i64 [%48, %$20] ; # X
...
; # (call $Put B)
  %59 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %59(i8 %46)
...
; # (call $Put (symByte P))
  %64 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %64(i8 %63)
...
; # (call $Put (symByte P))
  %69 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %69(i8 %68)
...
; # (call $Put (symByte P))
  %74 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %74(i8 %73)
  br label %$34
$34:
...
; # (call $Put (symByte P))
  %15 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %15(i8 %14)
; # (when (& B (hex "20")) (call $Put (symByte P)) (when (& B (hex "1...
; # (& B (hex "20"))
  %16 = and i8 %13, 32
...
; # (call $Put (symByte P))
  %25 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %25(i8 %24)
  br label %$13
$13:
...
; # (nil? X)
  %1 = icmp eq i64 %0, ptrtoint (i8* getelementptr (i8, i8* bitcast ([888 x i64]* @SymTab to i8*), i32 8) to i64)
...
; # (nil? (eval (car X)))
  %34 = icmp eq i64 %33, ptrtoint (i8* getelementptr (i8, i8* bitcast ([888 x i64]* @SymTab to i8*), i32 8) to i64)
; # (push 4 NIL ZERO NIL NIL NIL)
...
; # (call $Put (char "<"))
  %72 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %72(i8 60)
  br label %$15
$23:
...
; # (call $Put (char ">"))
  %77 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %77(i8 62)
  br label %$15
$25:
...
; # (call $Put (char "&"))
  %82 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %82(i8 38)
  br label %$15
$27:
...
; # (call $Put (char "\""))
  %87 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %87(i8 34)
  br label %$15
$29:
...
; # (call $Put (char " "))
  %92 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %92(i8 32)
  br label %$15
$31:
...
; # (call $Put (char "&"))
  ...
  call void %128(i8 38)
; # (call $Put (char "#"))
  %129 = load void(i8)*, void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**)
  call void %129(i8 35)
  br label %$39
$38:
...
$5:
  ...
  %11 = phi i32 [%8, %$3] ; # C
; # (call $Get)
  %12 = load i32()*, i32()** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 96) to i32()**)
  %13 = call i32 %12()
; # (lt0 (setq C (call $Get)))
...
; # (cons (mkChar C) $Nil)
  %51 = call i64 @cons(i64 %50, i64 ptrtoint (i8* getelementptr (i8, i8* bitcast ([888 x i64]* @SymTab to i8*), i32 8) to i64))
; # (save X)
...
; # (cons (mkChar C) $Nil)
  %113 = call i64 @cons(i64 %112, i64 ptrtoint (i8* getelementptr (i8, i8* bitcast ([888 x i64]* @SymTab to i8*), i32 8) to i64))
...
$20:
  ...
  %119 = phi i64 [%51, %$21], [ptrtoint (i8* getelementptr (i8, i8* bitcast ([888 x i64]* @SymTab to i8*), i32 8) to i64), %$23], [ptrtoint (i8* getelementptr (i8, i8* bitcast ([888 x i64]* @SymTab to i8*), i32 8) to i64), %$31] ; # ->
; # (drop *Safe)
...
$17:
  ...
  %126 = phi i64 [ptrtoint (i8* getelementptr (i8, i8* bitcast ([888 x i64]* @SymTab to i8*), i32 8) to i64), %$15], [%119, %$20] ; # ->
  br label %$8
$8:
  %127 = phi i64 [%21, %$6], [%124, %$17] ; # N
  %128 = phi i32 [%22, %$6], [%24, %$17] ; # C
  %129 = phi i64 [ptrtoint (i8* getelementptr (i8, i8* bitcast ([888 x i64]* @SymTab to i8*), i32 8) to i64), %$6], [%126, %$17] ; # ->
  ret i64 %129
}
@$CnkCnt = global i32 0
...
$2:
  %15 = phi i64 [%5, %$4], [%13, %$6], [%14, %$5] ; # ->
; # (nil? (eval (++ X)))
  %16 = icmp eq i64 %15, ptrtoint (i8* getelementptr (i8, i8* bitcast ([888 x i64]* @SymTab to i8*), i32 8) to i64)
...
; # (i8** $Get)
  %46 = bitcast i32()** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 96) to i32()**) to i8**
; # (val (i8** $Get))
  %47 = load i8*, i8** %46
  store i8* %47, i8** %45
; # (fun (i32) getChunked)
...
; # (i8** $Get)
  %74 = bitcast i32()** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 96) to i32()**) to i8**
; # (i8** $SvGet)
...
; # (i8** $Put)
  %46 = bitcast void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**) to i8**
; # (val (i8** $Put))
  %47 = load i8*, i8** %46
  store i8* %47, i8** %45
...
; # (i8** $Put)
  %78 = bitcast void(i8)** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 88) to void(i8)**) to i8**
; # (i8** $SvPut)
...
; # (t? F)
  %81 = icmp eq i64 %15, ptrtoint (i8* getelementptr (i8, i8* bitcast ([888 x i64]* @SymTab to i8*), i32 280) to i64)
...
; # (val $OutFile)
  %85 = load i8*, i8** bitcast (i8* getelementptr (i8, i8* bitcast ([25 x i64]* @env to i8*), i32 80) to i8**)
; # (flush (val $OutFile))
