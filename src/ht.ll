...
@SymTab = external global [880 x i64]
...
; # (cons (mkChar C) $Nil)
  %51 = call i64 @cons(i64 %50, i64 ptrtoint (i8* getelementptr (i8, i8* bitcast ([880 x i64]* @SymTab to i8*), i32 8) to i64))
; # (save X)
...
; # (cons (mkChar C) $Nil)
  %113 = call i64 @cons(i64 %112, i64 ptrtoint (i8* getelementptr (i8, i8* bitcast ([880 x i64]* @SymTab to i8*), i32 8) to i64))
...
$20:
  ...
  %119 = phi i64 [%51, %$21], [ptrtoint (i8* getelementptr (i8, i8* bitcast ([880 x i64]* @SymTab to i8*), i32 8) to i64), %$23], [ptrtoint (i8* getelementptr (i8, i8* bitcast ([880 x i64]* @SymTab to i8*), i32 8) to i64), %$31] ; # ->
; # (drop *Safe)
...
$17:
  ...
  %126 = phi i64 [ptrtoint (i8* getelementptr (i8, i8* bitcast ([880 x i64]* @SymTab to i8*), i32 8) to i64), %$15], [%119, %$20] ; # ->
  br label %$8
$8:
  %127 = phi i64 [%21, %$6], [%124, %$17] ; # N
  %128 = phi i32 [%22, %$6], [%24, %$17] ; # C
  %129 = phi i64 [ptrtoint (i8* getelementptr (i8, i8* bitcast ([880 x i64]* @SymTab to i8*), i32 8) to i64), %$6], [%126, %$17] ; # ->
  ret i64 %129
}
@$CnkCnt = global i32 0
...
; # (t? F)
  %81 = icmp eq i64 %15, ptrtoint (i8* getelementptr (i8, i8* bitcast ([880 x i64]* @SymTab to i8*), i32 280) to i64)
