...
$5:
  ...
  %11 = phi i32 [%8, %$3] ; # C
; # (call $Get)
  %12 = load i32()*, i32()** bitcast (i8* getelementptr (i8, i8* bitcast ([21 x i64]* @env to i8*), i32 96) to i32()**)
  %13 = call i32 %12()
; # (lt0 (setq C (call $Get)))
...
; # (call $Get)
  %70 = load i32()*, i32()** bitcast (i8* getelementptr (i8, i8* bitcast ([21 x i64]* @env to i8*), i32 96) to i32()**)
  %71 = call i32 %70()
; # (lt0 (setq C (call $Get)))
...
$6:
; # (val $Chr)
  %10 = load i32, i32* bitcast (i8* getelementptr (i8, i8* bitcast ([21 x i64]* @env to i8*), i32 64) to i32*)
  br label %$4
$4:
  %11 = phi i32 [-1, %$2], [%10, %$6] ; # ->
  ret i32 %11
...
; # (i8** $Get)
  %46 = bitcast i32()** bitcast (i8* getelementptr (i8, i8* bitcast ([21 x i64]* @env to i8*), i32 96) to i32()**) to i8**
; # (val (i8** $Get))
  %47 = load i8*, i8** %46
  store i8* %47, i8** %45
; # (fun (i32) getChunked)
...
; # (i8** $Get)
  %74 = bitcast i32()** bitcast (i8* getelementptr (i8, i8* bitcast ([21 x i64]* @env to i8*), i32 96) to i32()**) to i8**
; # (i8** $SvGet)
...
; # (val $OutFile)
  %85 = load i8*, i8** bitcast (i8* getelementptr (i8, i8* bitcast ([21 x i64]* @env to i8*), i32 80) to i8**)
; # (flush (val $OutFile))
